...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("JordiAragon.Cinema.Domain.ShowtimeAggregate.Showtime", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("JordiAragon.Cinema.Domain.AuditoriumAggregate.Auditorium", b =>
                {
                    b.OwnsMany("JordiAragon.Cinema.Domain.ShowtimeAggregate.ShowtimeId", "Showtimes", b1 =>
                        {
                            b1.Property<int>("Id")
                                .ValueGeneratedOnAdd()
                                .HasColumnType("int");
                    ...
                    b.OwnsMany("JordiAragon.Cinema.Domain.AuditoriumAggregate.Seat", "Seats", b1 =>
                        {
                            b1.Property<Guid>("Id")
                                .HasColumnType("uniqueidentifier")
            ...
            modelBuilder.Entity("JordiAragon.Cinema.Domain.ShowtimeAggregate.Showtime", b =>
                {
                    b.OwnsMany("JordiAragon.Cinema.Domain.ShowtimeAggregate.Ticket", "Tickets", b1 =>
                        {
                            b1.Property<Guid>("Id")
                                .HasColumnType("uniqueidentifier");
                            ...
                            b1.OwnsMany("JordiAragon.Cinema.Domain.AuditoriumAggregate.SeatId", "Seats", b2 =>
                                {
