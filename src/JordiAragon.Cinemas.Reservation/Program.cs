namespace JordiAragon.Cinemas.Reservation
{
    using Autofac;
    using Autofac.Extensions.DependencyInjection;
    using JordiAragon.Cinemas.Reservation.Common.Application;
    using JordiAragon.Cinemas.Reservation.Common.Infrastructure;
    using JordiAragon.Cinemas.Reservation.Common.Infrastructure.EntityFramework.Configuration;
    using JordiAragon.Cinemas.Reservation.Common.Infrastructure.EventStore;
    using JordiAragon.Cinemas.Reservation.Common.Presentation.WebApi;
