...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("JordiAragon.Cinemas.Reservation.Auditorium.Domain.Auditorium", b =>
                {
                    b.Property<Guid>("Id")
            ...
            modelBuilder.Entity("JordiAragon.Cinemas.Reservation.Movie.Domain.Movie", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("JordiAragon.Cinemas.Reservation.Showtime.Domain.Showtime", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("JordiAragon.Cinemas.Reservation.Auditorium.Domain.Auditorium", b =>
                {
                    b.OwnsMany("JordiAragon.Cinemas.Reservation.Showtime.Domain.ShowtimeId", "Showtimes", b1 =>
                        {
                            b1.Property<int>("Id")
                                .ValueGeneratedOnAdd()
                                .HasColumnType("int");
                    ...
                    b.OwnsMany("JordiAragon.Cinemas.Reservation.Auditorium.Domain.Seat", "Seats", b1 =>
                        {
                            b1.Property<Guid>("Id")
                                .HasColumnType("uniqueidentifier")
            ...
            modelBuilder.Entity("JordiAragon.Cinemas.Reservation.Showtime.Domain.Showtime", b =>
                {
                    b.OwnsMany("JordiAragon.Cinemas.Reservation.Showtime.Domain.Ticket", "Tickets", b1 =>
                        {
                            b1.Property<Guid>("Id")
                                .HasColumnType("uniqueidentifier");
                            ...
                            b1.OwnsMany("JordiAragon.Cinemas.Reservation.Auditorium.Domain.SeatId", "Seats", b2 =>
                                {
