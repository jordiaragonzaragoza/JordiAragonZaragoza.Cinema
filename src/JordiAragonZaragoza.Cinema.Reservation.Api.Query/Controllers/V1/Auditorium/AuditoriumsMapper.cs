namespace JordiAragonZaragoza.Cinema.Reservation.Api.Query.Controllers.V1.Auditorium
{
    ...
    {
        // Requests to queries
        public static GetShowtimesQuery ToQuery(
            this GetShowtimesRequest request)
        {
        ...
        public static GetAvailableSeatsQuery ToQuery(
            this GetAvailableSeatsRequest request)
        {
            ArgumentNullException.ThrowIfNull(request);
