namespace JordiAragon.Cinemas.Ticketing.Common.Infrastructure.EntityFramework.Configuration
{
    using JordiAragon.Cinemas.Ticketing.Common.Infrastructure.EntityFramework.Outbox;
