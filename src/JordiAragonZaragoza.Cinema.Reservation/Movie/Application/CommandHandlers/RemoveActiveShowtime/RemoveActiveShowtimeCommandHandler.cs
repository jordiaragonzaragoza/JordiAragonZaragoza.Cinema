namespace JordiAragonZaragoza.Cinema.Reservation.Movie.Application.CommandHandlers.RemoveActiveShowtime
{
    ...
    public sealed class RemoveActiveShowtimeCommandHandler : ICommandHandler<RemoveActiveShowtimeCommand>
    {
        ...
        public RemoveActiveShowtimeCommandHandler(IRepository<Movie, MovieId> movieRepository)
        {
        ...
        public async Task<Result> Handle(RemoveActiveShowtimeCommand request, CancellationToken cancellationToken)
        {
            ...
            existingMovie.RemoveActiveShowtime(new ShowtimeId(request.ShowtimeId));
