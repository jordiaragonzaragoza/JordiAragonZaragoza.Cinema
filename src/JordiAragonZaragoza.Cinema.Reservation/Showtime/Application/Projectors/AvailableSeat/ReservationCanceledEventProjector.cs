namespace JordiAragonZaragoza.Cinema.Reservation.Showtime.Application.Projectors.AvailableSeat
{
    ...
    public sealed class ReservationCanceledEventProjector : BaseEventHandler<ReservationCanceledEvent>
    {
        ...
        public ReservationCanceledEventProjector(
        ...
        public override async Task HandleAsync(ReservationCanceledEvent @event, CancellationToken cancellationToken)
        {
