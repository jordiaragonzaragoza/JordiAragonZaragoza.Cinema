namespace JordiAragonZaragoza.Cinema.Reservation.Showtime.Application.Policies.ShowtimeCanceled
{
    ...
    public sealed class MovieRemoveActiveShowtimePolicy : BaseEventHandler<ShowtimeCanceledEvent>
    {
        private readonly ICommandBus commandBus;

        public MovieRemoveActiveShowtimePolicy(
        ...
        public override async Task HandleAsync(ShowtimeCanceledEvent @event, CancellationToken cancellationToken)
        {
            ...
            await this.commandBus.SendAsync(new RemoveActiveShowtimeCommand(@event.MovieId, @event.AggregateId), cancellationToken);
        }
    }
}