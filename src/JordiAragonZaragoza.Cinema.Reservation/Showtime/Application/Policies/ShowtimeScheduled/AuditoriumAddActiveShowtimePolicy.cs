namespace JordiAragonZaragoza.Cinema.Reservation.Showtime.Application.Policies.ShowtimeScheduled
{
    ...
    public sealed class AuditoriumAddActiveShowtimePolicy : BaseEventHandler<ShowtimeScheduledEvent>
    {
        private readonly ICommandBus commandBus;

        public AuditoriumAddActiveShowtimePolicy(
        ...
        public override async Task HandleAsync(ShowtimeScheduledEvent @event, CancellationToken cancellationToken)
        {
            ...
            await this.commandBus.SendAsync(new AddActiveShowtimeCommand(@event.AuditoriumId, @event.AggregateId), cancellationToken);
        }
    }
}