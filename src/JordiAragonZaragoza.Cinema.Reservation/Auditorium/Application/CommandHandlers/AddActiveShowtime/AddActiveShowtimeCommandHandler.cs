namespace JordiAragonZaragoza.Cinema.Reservation.Auditorium.Application.CommandHandlers.AddActiveShowtime
{
    ...
    public sealed class AddActiveShowtimeCommandHandler : ICommandHandler<AddActiveShowtimeCommand>
    {
        ...
        public AddActiveShowtimeCommandHandler(IRepository<Auditorium, AuditoriumId> auditoriumRepository)
        {
        ...
        public async Task<Result> Handle(AddActiveShowtimeCommand request, CancellationToken cancellationToken)
        {
            ...
            existingAuditorium.AddActiveShowtime(new ShowtimeId(request.ShowtimeId));
