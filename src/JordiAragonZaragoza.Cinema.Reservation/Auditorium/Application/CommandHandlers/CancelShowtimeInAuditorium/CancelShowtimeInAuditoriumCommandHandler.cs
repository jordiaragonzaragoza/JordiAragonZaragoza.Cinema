namespace JordiAragonZaragoza.Cinema.Reservation.Auditorium.Application.CommandHandlers.CancelShowtimeInAuditorium
{
    ...
    public sealed class CancelShowtimeInAuditoriumCommandHandler : ICommandHandler<CancelShowtimeInAuditoriumCommand>
    {
        private readonly IRepository<Auditorium, AuditoriumId> auditoriumRepository;

        public CancelShowtimeInAuditoriumCommandHandler(IRepository<Auditorium, AuditoriumId> auditoriumRepository)
        {
            this.auditoriumRepository = auditoriumRepository ?? throw new ArgumentNullException(nameof(auditoriumRepository));
        }

        public async Task<Result> Handle(CancelShowtimeInAuditoriumCommand request, CancellationToken cancellationToken)
        {
            ...
            existingAuditorium.CancelShowtime(new ShowtimeId(request.ShowtimeId));
