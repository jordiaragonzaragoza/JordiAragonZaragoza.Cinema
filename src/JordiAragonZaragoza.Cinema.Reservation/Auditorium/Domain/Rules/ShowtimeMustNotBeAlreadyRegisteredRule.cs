namespace JordiAragonZaragoza.Cinema.Reservation.Auditorium.Domain.Rules
{
    ...
    public sealed class ShowtimeMustNotBeAlreadyRegisteredRule : IBusinessRule
    {
        private readonly IReadOnlyCollection<ShowtimeId> activeShowtimes;
        private readonly ShowtimeId newActiveShowtimeId;

        public ShowtimeMustNotBeAlreadyRegisteredRule(IReadOnlyCollection<ShowtimeId> activeShowtimes, ShowtimeId newActiveShowtimeId)
        {
