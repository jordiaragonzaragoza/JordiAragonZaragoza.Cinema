namespace JordiAragonZaragoza.Cinema.Reservation.FunctionalTests.Presentation.HttpRestfulApi.V2.User
{
    ...
    public sealed class GetUserReservationTests : BaseHttpRestfulApiFunctionalTests
    {
        ...
        public async Task GetUserReservation_WhenHavingValidArguments_ShouldReturnUserReservation()
        {
            ...
            var route = $"api/v2/{GetUserReservation.Route}";
            ...
            response.Should().BeEquivalentTo(reservationResponse);
        }
        ...
        private async Task<ReservationResponse> ReserveSeatsAsync(Guid showtimeId)
        {
            ...
            var response = await this.Fixture.HttpClient.PostAndDeserializeAsync<ReservationResponse>(reserveSeatsRoute, reserveSeatsContent, this.OutputHelper);
