namespace JordiAragon.Cinema.Reservation.UnitTests.TestUtils.Domain
{
    ...
    public static partial class Constants
    {
        public static class Movie
        {
            ...
            public static readonly StartingPeriod StartingPeriod = StartingPeriod.Create(new DateTimeOffset(DateTime.UtcNow.AddYears(1).Year, 1, 1, 1, 1, 1, 1, TimeSpan.Zero));
            public static readonly EndOfPeriod EndOfPeriod = EndOfPeriod.Create(DateTime.UtcNow.AddYears(2));
