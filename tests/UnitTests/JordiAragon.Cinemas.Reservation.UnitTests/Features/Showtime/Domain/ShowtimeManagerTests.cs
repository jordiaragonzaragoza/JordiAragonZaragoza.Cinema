namespace JordiAragon.Cinemas.Reservation.UnitTests.Showtime.Domain
{
    ...
    using Auditorium = JordiAragon.Cinemas.Reservation.Auditorium.Domain.Auditorium;
    using Seat = JordiAragon.Cinemas.Reservation.Auditorium.Domain.Seat;
    using Showtime = JordiAragon.Cinemas.Reservation.Showtime.Domain.Showtime;
